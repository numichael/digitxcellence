        ...
        <div className='w-full min-h-[50rem] flex flex-col p-4 py-20 lg:p-[10rem] gap-[10rem] items-center'>
            <div className='w-full flex flex-col max-w-[90rem] gap-[3rem] lg:gap-[6rem]'>
                <div className='flex flex-col items-center gap-4 lg:gap-6'>
                    ...
                    <h2 className='text-3xl lg:text-6xl'>Latest stories</h2>
                    <p className="text-[0.85rem] lg:text-lg  lg:w-[40rem] text-center">News From Abstrak And Around The World Of Web Design And Complete Solution of Online Digital Marketing</p>
                </div>
            </div>
            <div className="grid lg:grid-cols-2 w-full border-b max-w-[90rem]">
                {
                    news.map((info, index) => (
                        <div key={index} className='relative'>
                            <div className={`flex flex-col lg:flex-row gap-6 cursor-pointer lg:border-t transition-all duration-500 hover:border-blue-500 lg:pl-6 py-8 lg:py-14 mb-6`}>
                                ...
                                <div className="w-full lg:w-[40%] flex flex-col justify-evenly gap-4 lg:gap-0">
                                    <h3 className='text-lg lg:text-2xl font-semibold hover:text-blue-500 transition-all'>{info.name}</h3>
                                    <p className='text-[#3c424577] text-[0.85rem] lg-text-md'>{info.text}</p>
                                    <h4 className='text-[0.85rem] lg:text-lg font-semibold hover:text-blue-500 transition-all'>{"Learn More >"}</h4>
                                </div>
                            </div>

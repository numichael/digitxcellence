...
const Intro = () => {
    return (
        <div className='w-full min-h-[30rem] max-h-[50rem] pt-[10rem] pb-8 px-4 lg:px-[4rem] gap-10 lg:max-w-[90rem] flex flex-col lg:flex-row justify-center items-center'>
            <div className='w-full lg:w-1/2 flex flex-col gap-5 lg:gap-10'>
                ...
                <div>
                    <button className='p-4 outline-none border border-green-700 hover:scale-105 bg-green-700 transition-all duration-500 text-white font-medium rounded-lg'>
                        Get Started
                    </button>
                </div>
            </div>

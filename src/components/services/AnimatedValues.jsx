            ...
            <div className="w-full max-w-[70rem] grid lg:grid-cols-2 gap-10">
                {
                    values.map((value, index) => (
                        <div key={index} className={`border w-full transition-all duration-500 ${value.hovered ? "h-[30rem]" : "h-[10rem]"} relative bg-green-700`} onMouseEnter={() => resize(value)} onMouseLeave={() => resize(value)}>

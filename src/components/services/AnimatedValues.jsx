...
const AnimatedValues = () => {
    ...
    const [values, modifyList] = useState([
        { image: `https://img.freepik.com/free-photo/pensive-young-female-employee-using-tablet-outside_74855-1176.jpg?size=626&ext=jpg&ga=GA1.1.1224184972.1712016000&semt=ais`, hovered: true, name: "Experienced Professionals", text: "With extensive industry experience and expertise acquired over many years, our team consistently delivers exceptional results for every project. Leveraging our comprehensive understanding of industry dynamics and emerging trends, we craft tailored solutions that exceed client expectations." },
        { image: `https://www.thelist.com/img/gallery/the-surprising-reason-covid-19-wont-keep-you-from-shaking-hands/l-intro-1617383063.jpg`, hovered: true, name: "Honesty", text: "In all we do, transparency and integrity shine bright, Guiding us with honesty, our actions alight. You can trust us to always be forthright, For openness and sincerity are our guiding light." },
        { image: `https://st3.depositphotos.com/7865540/12758/i/450/depositphotos_127584304-stock-photo-businessman-writing-on-blackboard.jpg`, hovered: true, name: "Dedication", text: "Our dedication stands firm, promising solutions that go beyond expectations. Regardless of project size or complexity, we strive for excellence. With tailored approaches, we ensure satisfaction in every endeavor. Trust us to deliver results that surpass your vision." },
        { image: `https://media.istockphoto.com/id/1177089402/photo/what-is-next-handwritten-with-white-marker.jpg?s=612x612&w=0&k=20&c=QjVaEFpbPqdltLIe6Kz6F8sUBYTIgrmB2rPZ_K7Y_jI=`, hovered: true, name: "Continued Support", text: "We're dedicated to standing by your side every step of the way, offering unwavering support and guidance that extends far beyond the completion of the project, ensuring your sustained success, growth, fulfillment, and satisfaction." },
    ])
...
const Value = ({ value, index }) => {
    ...
    const prop1 = { top: inView ? "0rem" : "-5rem", left: inView ? "0rem" : "-5rem" }
    const prop2 = { top: inView ? "0rem" : "-5rem", right: inView ? "0rem" : "-5rem" }
    const prop3 = { bottom: inView ? "0rem" : "-5rem", left: inView ? "0rem" : "-5rem" }
    const prop4 = { bottom: inView ? "0rem" : "-5rem", right: inView ? "0rem" : "-5rem" }

    return (
        <div ref={ref} style={index === 0 ? prop1 : index === 1 ? prop2 : index === 2 ? prop3 : prop4} className={`relative border w-full transition-all duration-1000 h-[30rem] bg-green-700`}>

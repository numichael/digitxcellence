        ...
        <a href={link} target='_blank' className='cursor-pointer w-full lg:h-[45rem]'>
            <div className="relative w-full h-[80%] flex gap-2 lg:gap-4">
                ...
                <div className="flex flex-col gap-2 lg:gap-4 w-[50%] h-full">
                    <img style={image2Style} src={images[1]} ref={ref2} className='transition-all relative duration-1000 w-full border h-1/2' alt="Your Image" />
                    <img style={image3Style} src={images[2]} ref={ref3} className='transition-all relative duration-1000 w-full border h-1/2' alt="Your Image" />
                </div>
            </div>

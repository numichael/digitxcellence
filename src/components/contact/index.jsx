            ...
            <Element name="home" className='w-full pt-[2rem] lg:max-w-[90rem] flex flex-col items-center gap-6'>
                ...
                <div className='flex flex-wrap  gap-4 lg:gap-6 items-center justify-center'>{
                    contacts.map((contact, index) => (
                        <a href={contact.link} target='_blank' key={index} className='cursor-pointer border-b-4 transition-all duration-500 border-transparent hover:border-green-700 h-[10rem] w-[10rem] lg:w-[15rem] lg:h-[15rem] bg-green-50 flex flex-col items-center justify-center gap-2 rounded-md'>
